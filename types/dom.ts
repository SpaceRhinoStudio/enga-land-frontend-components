...
import { ValueTypeOfKey } from './utils'
...
export type ControlStream<Actions extends string, Payloads extends _.Dictionary<unknown>> = Subject<
  ControlStreamData<Actions, Payloads>
>
