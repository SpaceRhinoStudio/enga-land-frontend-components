...
<div use:backdrop>
  ...
  <div
    data-name="top-hint"
    class="will-change-[opacity] fixed z-[25] -top-px left-0 right-0 bg-gradient-to-b to-transparent pointer-events-none select-none -translate-y-px {className?.hint ??
      'from-primary-990'}"
  ...
  <div
    ...
    class="will-change-[opacity] fixed z-[25] -bottom-px left-0 right-0 bg-gradient-to-t to-transparent pointer-events-none select-none {className?.hint ??
      'from-primary-990'}"
